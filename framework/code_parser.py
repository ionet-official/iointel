...
def generate_code_from_function(func: FunctionDefinition) -> str:
    code_lines = []
...
def generate_code_from_class(cls: ClassDefinition) -> str:
    code_lines = []
...
def generate_code_from_module(module: PythonModule) -> str:
    code_lines = []
    if module.docstring:
    ...
    for func in module.functions:
        code_lines.append(generate_code_from_function(func))
        code_lines.append("")
    for cls in module.classes:
        code_lines.append(generate_code_from_class(cls))
        code_lines.append("")
    if module.body:
