...
class BrowserbaseTools:
    ...
    @register_tool(name="browserbase_navigate")
    ...
    @register_tool(name="browserbase_screenshot")
    ...
    @register_tool(name="browserbase_get_page_content")
    ...
    @register_tool(name="browserbase_close_session")
