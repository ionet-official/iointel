...
class E2BTools:
    def __init__(
        ...
        """Initialize E2B for code interpretation and running Python code in a sandbox.
    ...
    @register_tool(name="sandbox_run_python_code")
    ...
    @register_tool(name="sandbox_upload_file")
    ...
    @register_tool(name="sandbox_download_file")
    def download_png_result(
        self, result_index: int = 0, output_path: Optional[str] = None
    ) -> str:
        """
        Add a PNG image result from the last code execution to the agent.
        ...
        try:
            ...
            if output_path:
                img = BinaryContent(data=png_data, media_type='image/png'),
            else:
                img = ImageUrl(url=file_url)
    ...
    @register_tool(name="sandbox_download_chart_data")
    def download_chart_data(
        self, result_index: int = 0, output_path: Optional[str] = None, add_as_artifact: bool = True
    ) -> str:
        """
    ...
    @register_tool(name="sandbox_download_file_from_sandbox")
    ...
    @register_tool(name="sandbox_run_command")
    def run_command(
        self,
        command: str,
    ...
    @register_tool(name="sandbox_stream_command")
    ...
    @register_tool(name="sandbox_run_background_command")
    ...
    @register_tool(name="sandbox_kill_background_command")
    ...
    @register_tool(name="sandbox_list_files")
    ...
    @register_tool(name="sandbox_read_file_content")
    ...
    @register_tool(name="sandbox_write_file_content")
    ...
    @register_tool(name="sandbox_watch_directory")
    ...
    @register_tool(name="sandbox_get_public_url")
    ...
    @register_tool(name="sandbox_run_server")
    ...
    @register_tool(name="sandbox_set_timeout")
    ...
    @register_tool(name="sandbox_get_timeout")
    ...
    @register_tool(name="sandbox_shutdown")
    ...
    @register_tool(name="sandbox_list_running_sandboxes")
