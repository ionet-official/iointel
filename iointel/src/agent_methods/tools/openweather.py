...
class OpenWeatherTools:
    ...
    @register_tool(name="openweather_geocode_location")
    ...
    @register_tool(name="openweather_get_current_weather")
    ...
    @register_tool(name="openweather_get_forecast")
    ...
    @register_tool(name="openweather_get_air_pollution")
