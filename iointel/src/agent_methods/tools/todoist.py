...
class TodoistTools:
    ...
    @register_tool(name="todoist_create_task")
    def create_task(
        self,
        content: str,
    ...
    @register_tool(name="todoist_get_task")
    ...
    @register_tool(name="todoist_update_task")
    def update_task(
        self,
        task_id: str,
    ...
    @register_tool(name="todoist_close_task")
    ...
    @register_tool(name="todoist_delete_task")
    ...
    @register_tool(name="todoist_get_active_tasks")
    ...
    @register_tool(name="todoist_get_completed_tasks")
