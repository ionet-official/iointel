...
class DiscordTools:
    ...
    @register_tool(name="discord_send_message")
    ...
    @register_tool(name="discord_get_channel_info")
    ...
    @register_tool(name="discord_list_channels")
    ...
    @register_tool(name="discord_get_channel_messages")
    ...
    @register_tool(name="discord_delete_message")
